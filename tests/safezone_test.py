...
def _make_planner(safezones=None, start=(10.0, 10.0), goal=(90.0, 90.0), map_bounds=None):
...
def test_in_bounds_rectangle_with_explicit_map_bounds():
    ...
    planner = _make_planner(safezones=None, map_bounds=(config.MAP_WIDTH, config.MAP_HEIGHT))
...
def test_check_collision_rejects_chord_leaving_nonconvex_zone():
    ...
    u_shape = [(0, 0), (100, 0), (100, 100), (60, 100),
